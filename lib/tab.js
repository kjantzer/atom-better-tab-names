...
const CLASS_NAME = 'better-tab-names';
...
class Tab {
    ...
    checkTab() {
        ...
        //         (!atom.config.get('better-tab-names.equalsNamesEnabled') || !mapNames.hasReapeatedNames(name))
        //     )
        // ) {
        //     this.clearTab();
        //     return;
        ...
        const numOfFolders = atom.config.get('better-tab-names.numberOfFolders');
